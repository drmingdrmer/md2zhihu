...
![](https://cdn.jsdelivr.net/gh/drmingdrmer/md2zhihu@_md2zhihu_zhihu_a6a06ae4/zhihu/simple/graphLRAHardedge--LinktextBRound-38e149134ebbdae5.jpg)

例如 `$$ ||X{\vec {\beta }}-Y||^{2} $$`
![](https://cdn.jsdelivr.net/gh/drmingdrmer/md2zhihu@_md2zhihu_zhihu_a6a06ae4/zhihu/simple/slim.jpg)
...
-   链接列表:
    ...
    <tr class="odd">
    <td style="text-align: center;"><img src="https://cdn.jsdelivr.net/gh/drmingdrmer/md2zhihu@_md2zhihu_zhihu_a6a06ae4/zhihu/simple/slim.jpg" /></td>
